...
@Component
public class RetrieveModelListByTypeRequest {
    ...
    public RetrieveModelListByTypeRequest() {
    }

    public RetrieveModelListByTypeRequest(Integer page, Integer pageSize, String sortBy) {
        this.page = page;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RetrieveModelListByTypeRequest)) return false;

        RetrieveModelListByTypeRequest that = (RetrieveModelListByTypeRequest) o;
