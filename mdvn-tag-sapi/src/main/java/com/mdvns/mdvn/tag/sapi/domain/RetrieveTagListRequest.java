...
public class RetrieveTagListRequest {
    ...
    public RetrieveTagListRequest(Integer page, Integer pageSize, String sortBy) {
        this.page = page;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RetrieveTagListRequest)) return false;

        RetrieveTagListRequest that = (RetrieveTagListRequest) o;
